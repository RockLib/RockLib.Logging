...
public class RequestMethodContextProvider : IContextProvider
{
    ...
    public RequestMethodContextProvider(string? requestMethod) => RequestMethod = requestMethod;
    ...
    public void AddContext(LogEntry logEntry) => logEntry.SetRequestMethod(RequestMethod);
}
