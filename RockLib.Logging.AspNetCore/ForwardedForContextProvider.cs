...
public class ForwardedForContextProvider : IContextProvider
{
    ...
    public ForwardedForContextProvider(StringValues forwardedFor) => ForwardedFor = forwardedFor;
    ...
    public void AddContext(LogEntry logEntry) => logEntry.SetForwardedFor(ForwardedFor);
}
